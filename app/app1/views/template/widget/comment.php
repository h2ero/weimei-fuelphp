...
<?php if($key%2==0){ ?>
<a class="commentsAvatar" href="/user/i/<?=$c['userId']?>"><img src="<?=($c['icon'])?>"></a>
<?php }?>
<div class="reply-doc">
<div class="commentsMsg"><a href="/user/i/<?=$c['userId']?>"><?=$c['username']?></a>于<?=(strtotime($c['date']));?>说|<a class="reply" href="#reply" >回复</a></div>
